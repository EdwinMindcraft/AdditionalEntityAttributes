...
public abstract class BackgroundRendererMixin {
	...
	@ModifyConstant(method = "setupFog(Lnet/minecraft/client/Camera;Lnet/minecraft/client/renderer/FogRenderer$FogMode;FZF)V", constant = @Constant(floatValue = 192F, ordinal = 0))
